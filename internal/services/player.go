...
//		UpdatePlayer(domain.Player, uint) error
...
//}
//
////func (s *playerimpl) CreatePlayer(p domain.Player) error {
...
//}
//
//func (s *playerimpl) UpdatePlayer(player domain.Player, id uint) error {
